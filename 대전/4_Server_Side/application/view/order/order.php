                ...
                <div class="form-group col-8 mt-2">
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" name="example-inline-radios" value="option1" onclick="location.replace('/order/order/?order=grade<?php if(isset($_GET['type'])) echo "&type=".$_GET['type']; if(isset($_GET['idx'])) echo "&idx=".$_GET['idx'] ?>')" <?php if(isset($_GET['order']) && $_GET['order'] == "grade") echo "checked" ?>>
                      <span class="custom-control-label">평점순</span>
                    </label>
                    <label class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" name="example-inline-radios" value="option2" onclick="location.replace('/order/order/?order=review<?php if(isset($_GET['type'])) echo "&type=".$_GET['type']; if(isset($_GET['idx'])) echo "&idx=".$_GET['idx'] ?>')" <?php if(isset($_GET['order']) && $_GET['order'] == "review") echo "checked" ?>>
                      <span class="custom-control-label">리뷰순</span>
                    </label>
                    <label class="custom-control custom-radio custom-control-inline">
                      <input type="radio" class="custom-control-input" name="example-inline-radios" value="option3" onclick="location.replace('/order/order/?order=distance<?php if(isset($_GET['type'])) echo "&type=".$_GET['type']; if(isset($_GET['idx'])) echo "&idx=".$_GET['idx'] ?>')" <?php if(isset($_GET['order']) && $_GET['order'] == "distance") echo "checked" ?>>
                        ...
                        <tr title="<?php echo $data->name ?>">
                          ...
                          <td class="text-right">
                            <label class="custom-switch">
                              <input type="radio" name="option" class="custom-switch-input" onclick="location.replace('/order/order/?idx=<?php echo $data->idx ?><?php if(isset($_GET['type'])) echo "&type=".$_GET['type'] ?>')" <?php if(isset($_GET['idx']) && $_GET['idx'] == $data->idx) echo "checked" ?>>
