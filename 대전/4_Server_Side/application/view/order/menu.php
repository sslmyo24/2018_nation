              ...
              <div class="row">
                ...
                <div class="card" style="position: fixed; margin-left: 1180px; top: 210px; max-height: 600px; width: 350px; z-index: 900;">
                  ...
                  <div class="col text-right">
                    <a href="/order/cartEmpty/?idx=<?php echo $_GET['idx'] ?>" class="btn btn-sm btn-outline-primary">비우기</a>
                  </div>
                ...
                <?php if(isset($_SESSION['cart'])):
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          ...
                          <div class="col-auto">
                            <a href="/order/cartChange/?i=<?php echo $i ?>&idx=<?php echo $_GET['idx'] ?>" class="icon"><i class="fe fe-x"></i></a>
                          </div>
                        </div>
                      </li>
                    <?php endfor;
