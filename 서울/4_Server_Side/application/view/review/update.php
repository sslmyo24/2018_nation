<div class="review-write">
    ...
    <form action="" method="post" onsubmit="submitContents(this); return false;" enctype="multipart/form-data">
        <input type="hidden" name="action" value="update">
        <ul class="row s12">
            <li class="col s3 input-field">
                <select name="destination" tabindex="-1">
            <?php foreach ($tour as $tour_data) { ?>
                    <option value="<?php echo $tour_data->idx ?>" <?php if($data->destination == $tour_data->idx){ ?> selected="" <?php } ?> ><?php echo $tour_data->subject ?></option>
            <?php } ?>
                </select>
            </li>
            ...
            <li class="col s12 input-field file-field">
                ...
                <div class="file-path-wrapper">
                    <input class="file-path validate" type="text" value="<?php echo $data->file ?>">
                </div>
            </li>
            <li class="col s12">
                <textarea id="review-content" name="content" cols="80" rows="20" style="width: 100%; height: 300px; display: none;"><?php echo $data->content ?></textarea>
            </li>
            <li class="col s12">
                <div class="center">
